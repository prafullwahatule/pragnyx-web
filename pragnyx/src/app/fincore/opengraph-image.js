...
export const alt = "PragnyX FinCore — The AI Financial Operating System for Modern Businesses";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", marginTop: 28, fontSize: 54, fontWeight: 700, lineHeight: 1.15, maxWidth: 960, color: "#15152b" }}>
          The AI Financial Operating System for Modern Businesses
        </div>
        <div style={{ display: "flex", marginTop: 22, fontSize: 22, color: "#5c5c7a", maxWidth: 760 }}>
          Accounting to compliance — one platform, every workflow.
        </div>
      </div>
    ),
    { ...size }
