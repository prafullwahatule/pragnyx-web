...
const COLUMNS = [
  {
    ...
    links: [
      ...
      { href: "/solutions#pragnyx-eduos", label: "Solutions" },
    ],
  },
  {
    heading: "Resources",
    links: [
      { href: "/eduos#faq", label: "FAQ" },
      { href: "/contact", label: "Documentation (coming soon)" },
      { href: "/eduos/login", label: "Log in" },
      { href: "/contact", label: "Contact" },
    ],
  },
];

export default function EduOSFooter() {
  return (
    <footer style={{ borderTop: "1px solid var(--e-border)", background: "var(--e-bg-alt)" }}>
      <div className="e-shell" style={{ padding: "64px 24px 40px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: 48 }} className="e-footer-grid">
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
              ...
              <span style={{ fontFamily: "var(--e-font-display)", fontWeight: 600, fontSize: 15 }}>EduOS</span>
            </div>
            <p style={{ marginTop: 14, maxWidth: 320, fontSize: 14, color: "var(--e-ink-mute)", lineHeight: 1.6 }}>
              The AI operating system for modern educational institutions. A product by PragnyX.
            </p>
        ...
        >
          <span>© {new Date().getFullYear()} PragnyX. PragnyX EduOS — all rights reserved.</span>
