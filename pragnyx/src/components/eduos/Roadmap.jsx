...
const ROADMAP = [
  "Deep AI model integration for natural-language queries & report generation",
  "NAAC accreditation reporting",
  "NBA accreditation reporting",
  "Predictive analytics across admissions, attendance & finance",
];
