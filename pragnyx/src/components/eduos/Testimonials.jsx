...
const TESTIMONIALS = [
  { quote: "Placeholder — real testimonial to be added after pilot institutions go live.", name: "Institution Name", role: "Principal" },
  { quote: "Placeholder — real testimonial to be added after pilot institutions go live.", name: "Institution Name", role: "Administrator" },
  { quote: "Placeholder — real testimonial to be added after pilot institutions go live.", name: "Institution Name", role: "Finance Head" },
];
  ...
  return (
    <section className="e-section" style={{ background: "var(--e-bg-alt)" }}>
      <div className="e-shell">
        <Reveal>
          <span className="e-eyebrow">Trusted by institutions</span>
