// Signature hero visual: a stack of overlapping dashboard cards.
// Encodes the product's real differentiator (one OS, real-time financial
// views across every function) instead of a generic single bar-chart mockup.
// Replace the placeholder bars with real product screenshots later —
// each card below is a natural drop-in slot (see comments).

const ROLE_CARDS = [
  { label: "Executive", metric: "₹42.8L", metricLabel: "Revenue (MTD)", bars: [60, 82, 74, 91, 68], accent: "primary" },
  { label: "Accountant", metric: "₹18.4L", metricLabel: "GST input credit", bars: [40, 55, 70, 65, 88], accent: "gold" },
  { label: "Inventory", metric: "1,204", metricLabel: "SKUs in stock", bars: [30, 45, 62, 80, 95], accent: "primary" },
];
