    ...
    <section className="e-dot-grid e-mesh-bg" style={{ paddingTop: 64, paddingBottom: 80, overflow: "hidden" }}>
      <div className="e-shell" style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 48, alignItems: "center" }} id="e-hero-grid">
        <div>
          ...
          >
            <span className="e-eyebrow" style={{ margin: 0 }}>Cloud Accounting ERP + AI Financial OS</span>
          </span>
          <h1 style={{ marginTop: 20, fontSize: "clamp(34px, 5vw, 56px)", fontWeight: 600, lineHeight: 1.08 }}>
            The AI Financial Operating System for <span className="e-gradient-text">Modern Businesses</span>
          </h1>
          <p style={{ marginTop: 22, fontSize: 18, lineHeight: 1.6, color: "var(--e-ink-mute)", maxWidth: 520 }}>
            Manage accounting, GST, invoicing, inventory, banking, payroll, and compliance —
            from one intelligent cloud platform, built for India&apos;s next generation of businesses.
          </p>
          <div style={{ marginTop: 32, display: "flex", gap: 14, flexWrap: "wrap" }}>
            <Link href="/fincore/signup" className="e-btn e-btn-primary">
              Start Free Trial <ArrowRight size={16} strokeWidth={2} />
            </Link>
            <Link href="/fincore/pricing" className="e-btn e-btn-ghost">
              See Pricing
            </Link>
          </div>
          <div style={{ marginTop: 40, display: "flex", gap: 28, flexWrap: "wrap" }}>
            {[
              ["15+", "Financial modules, one system"],
              ["99.9%", "Uptime target"],
