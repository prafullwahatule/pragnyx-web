...
const STEPS = [
  { n: "01", title: "Choose your plan", desc: "Compare Starter, Professional and Enterprise, then pick the one that fits your business." },
  { n: "02", title: "Business details", desc: "Company name, business type, GST, PAN, industry & employee count — takes about two minutes." },
  { n: "03", title: "Payment", desc: "Secure checkout via Razorpay. Enterprise plans skip this step for a sales-assisted setup instead." },
  { n: "04", title: "Workspace created automatically", desc: "Your subdomain, database, and admin account are provisioned the moment payment clears." },
  { n: "05", title: "Credentials emailed", desc: "Company ID, workspace URL, and a temporary admin password land in your inbox." },
